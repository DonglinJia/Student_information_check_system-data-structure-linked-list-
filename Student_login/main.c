...
// use doulbe strategy to input the information
char *inputstr() {
    char c;
...
//check whether enter a legal password
...
// make structrue student, everytime make a new student
